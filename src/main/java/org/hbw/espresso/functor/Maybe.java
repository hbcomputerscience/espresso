...
public class Maybe<T> implements Functor<T> {
	...
	/**
	 * Takes a function that takes a parameter of the type T, which is the same type as the value of the maybe and, if the value of the maybe is not nothing, returns a new maybe containing the return value of the function called with the value of the maybe.
	 * @param <T2>
	 * @param f
	 * @return new maybe with the value of the return value of f called with the argument of the value of the maybe
	 */
	@Override
	...
	/**
	 * Takes a consumer f and if the value is not null, calls f with the argument of the value of the maybe.
	 * @param f 
	 */
